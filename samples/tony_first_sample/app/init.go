...
var compilers = []grunt.GruntCompiler{
	...
	grunt.GruntCompiler{Name: "tony_first_sample JS", Path: "app/assets/js/tony_first_sample", Grunt: "uglify:tony_first_sample_js"},
	grunt.GruntCompiler{Name: "tony_first_sample SASS", Path: "app/assets/sass/tony_first_sample", Grunt: "sass:tony_first_sample_css"},
}
